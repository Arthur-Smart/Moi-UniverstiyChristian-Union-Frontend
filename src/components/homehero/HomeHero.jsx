    ...
    <div className='homehero flex flex-col items-center justify-center'>
        <div className='container flex items-center justify-center'>
            <div  className='texts-container flex flex-col items-ceter justify-center text-white'>
                ...
                <p data-aos="fade-up" data-aos-duration="3000"  className='text-center'>Our Theme Verse: "Ephesians 4:1-3" | Living a life worth of our calling</p>
                ...
                <div data-aos="fade-up" data-aos-duration="3000" className='flex items-center justify-center'>
                  ...
                  <a href='https://youtube.com/@muaccucu364' target='_blank'><p className='text-slate-300 hover:text-white' ><i class="fa-brands fa-square-youtube fa-2x ml-3 cursor-pointer"></i></p></a>
                </div>
            </div>
