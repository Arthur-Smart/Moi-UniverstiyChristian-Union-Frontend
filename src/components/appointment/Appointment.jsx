  ...
  return (
    <div className='appointment flex flex-col items-center justify-center py-10'>
        ...
        <div className='container flex flex-col items-center justify-center mt-5'>
            ...
            <input value={date} onChange={(e) => setDate(e.target.value)}className='bible-inputs border-2 py-3 px-1 mb-2 rounded-md outline-green-100 ' type='date' placeholder='Chooses date'/>
